...
export type SearchResultQuery$variables = {
  cursor?: string | null;
  first?: number | null;
  query: string;
};
export type SearchResultQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"RepositoryList_query">;
};
export type SearchResultQuery = {
  response: SearchResultQuery$data;
  variables: SearchResultQuery$variables;
};
...
(node as any).hash = "a17091f493df9c000830adcd37af33ee";
